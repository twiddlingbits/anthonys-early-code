...
*-----------------------------------------------------------------------
      ...
      XDEF  _pack_screen_320_200

      csect text

_pack_screen_320_200
      link     a0,#0
      movem.l  a1-a6/d1-d7,-(a7)

      movea.l  buffer(a0),a1
      movea.l  buffer(a0),a6
      add.l    #640,a6
      movea.l  p0(a0),a2
      movea.l  p1(a0),a3
      movea.l  p2(a0),a4
      movea.l  p3(a0),a5
      move.l   #199,d5             * number of lines to update
...
loop: 
      ...
      move.b   d0,(a6)+               * save byte in 2nd line
      move.b   d0,(a6)+               * save byte  (low res done twice)
