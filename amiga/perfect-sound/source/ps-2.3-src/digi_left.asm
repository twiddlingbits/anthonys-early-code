...
*-----------------------------------------------------------------------
* Calling sequence:
*   digi_left(buffer, maxsize, period)
*
*-----------------------------------------------------------------------
*
* Function:
*
* Digitizes from the left channel of a perfect sound digitizer.
...
_digi_left:
      ...
      move.w   d0,aud0per        * Tell hardware speed we want
...
* let user hear sound while digitizing
      ...
      move.w   d1,aud0dat        * byte twice.
      move.w   #$80,intreq       * Reset audio interupt flag

wait: btst     #7,intreqr+1      * Wait for hardware to signal time
