...
See "Perfect Sound Ver 3.22 Release 08/15/91" below for a list of
changes new to version Perfect Sound 3.22.
...
Audition 4 takes off where AudioMaster III left off. Available NOW from
...
7. Freehand edit
8. Edit in zoom mode
9. 100% Assembler for speed and memory efficiency
 
Perfect Sound Ver 3.22 Release 08/15/91
=======================================

1. Fixed bug that made IFF files unreadable by some
   software (eg. CanDo).
2. Fixed bug that would sometimes leave you in paste/mix mode
