...
* Delays the monitored signal.  The length of the delay
...
*
* The following code is from the "intermediate speed" recording code.
...
try3: move.b   (a5),d1           * 40 get data
      ...
      move.b   d1,(a4)           * 8 put byte into MSByte of a word
...
* let user hear sound while digitizing
      ...
      move.w   (a4),d1           * 8 shifted low byte to high byte
      move.b   0(a1,d7),d1       * 8 Let audio hardware play same
      move.w   d1,(a2)           * 8 byte twice.  a2 = aud1dat
      move.b   d2,0(a1,d7)       * 8 Save new sample In buffer for later
