...
*
      ...
      lea      intreq,a3         * ""
      move.w   #$80,d3          * "": $100=right, $80=left
...
* let user hear sound while digitizing
      ...
      move.w   d2,aud0dat        * 8 byte twice.  a2 was aud0dat
...
*
		move.b	icr,d1				* save bits we clear
		or.b		d1,_cia_a_icr		* save_par sets them again
      btst     #3,d1
      beq      nokey
      nop
...
uparrow:
      jsr      rest
      move.b   #4,data2          * right channel also means clock up
      jsr      rest
      bclr     #7,data1
      jsr      rest
      bset     #7,data1
...
xxxx:
      ...
      move.w   #0,aud0vol        * turn volume totally off
