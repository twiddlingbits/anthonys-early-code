...
* and.w     #31,d0         * mask sign bits and generate 0->31
* lea       mult_tab,a0
...
tog:
      not.w    flags(a0)
      cmp.w    #0,flags(a0)      * 0 in flags means plot
      beq      tog1              * beq if we are ploting
      move.b   #25,talo          * 25 = approx. 14,000 samp/sec
      bra      no_plot
tog1: move.b   #35,talo          * slow down when graphing (35 = 10,222)
      bra      no_plot
downarrow:
      move.b   #0,data2          *left
*      nop
