...
*      move.b   #%01111111,icr    * disable all inturupts from cia
...
*
      ...
      nop
      move.b   #3,talo           * speed up counter (was 25)
      nop
      move.b   #$51,cra           * SP=output, pulse, start timer, load
      nop
      move.b   #$00,sdr          * shift 00000000 @ 8.4 usec/bit (MSB 1st)
pze:  nop
      btst     #3,icr            * wait for  KDAT to finish pulsing
      beq      pze               * by sending zeros & ones thru SP
      move.b   #7,cra            * for toggle use 7, 11 for pulse
      nop
      move.b   #25,talo          * restore timer count value
      nop
