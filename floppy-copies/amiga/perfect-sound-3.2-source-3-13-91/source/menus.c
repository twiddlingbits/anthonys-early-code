...
struct IntuiText SubText[] =
{
   ...
   { 0, 1, JAM1, 0, 1, &taPlain, 0, NULL },
   { 0, 1, JAM1, 0, 1, &taPlain, 0, NULL },
   { 0, 1, JAM1, 0, 1, &taPlain, 0, NULL }, /* added this for ASF */
   { 0, 1, JAM1, 0, 1, &taPlain, 0, NULL }, /* added this for ASF */
};
...
struct MenuItem SubItems[] =
{
   ...
   {
      &SubItems[3], 111, 20, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[2], NULL, NULL, NULL, NULL 
   },
   {
      NULL, 111, 30, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[3], NULL, NULL, NULL, NULL
   },
   {
      &SubItems[5], 111, 0, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[4], NULL, NULL, NULL, NULL
   },
   {
      &SubItems[6], 111, 10, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[5], NULL, NULL, NULL, NULL
   },
   {
      &SubItems[7], 111, 20, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
   ...
   {
      &SubItems[9], 191, 0, 56, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
struct MenuItem Items[] =
{
   ...
   },
   {
      ...
      0, (APTR)&ItemText[3], NULL, NULL, &SubItems[4], NULL
   },
   {
   ...
   },
   {
      ...
      0, (APTR)&ItemText[9], NULL, '0', NULL, NULL
   },
   {
   ...
   },
   {
      ...
      0, (APTR)&ItemText[26], NULL, NULL, &SubItems[8], NULL
   },
   {
      NULL, 0, 30, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[27], NULL, NULL, &SubItems[10], NULL
   },
   {
   ...
   {
      &Items[31], 0, 20, 219, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[30], NULL, NULL, NULL, NULL
   },
   {
      &Items[32], 0, 30, 219, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[31], NULL, NULL, NULL, NULL
   },
   {
      NULL, 0, 40, 219, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
