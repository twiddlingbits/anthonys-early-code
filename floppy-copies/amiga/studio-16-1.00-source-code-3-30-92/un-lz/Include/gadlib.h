...
#define BUTN_LOOP (1<<27)
#define DROPLIST_SELECTED (1<<27)
#define GAD_LOOPLIST (1<<28)
#define RENDER_ONLY (1<<29)
#define LIST_SORTED (1<<30)
#define NOT_IN_CHAIN (1<<31)
