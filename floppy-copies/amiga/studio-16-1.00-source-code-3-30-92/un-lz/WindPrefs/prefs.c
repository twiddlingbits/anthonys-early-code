...
if (wind = OpenNewWind(&NewWind,mod->state,HIDEMESSAGE|DONTMOVEWINDOW,NULL))
	{
...
if ((Hwind = OpenNewWind(&HNewWind,NULL,HIDEMESSAGE,NULL))==NULL)  {telluser("Preferences:","Can not open window!",0);Quit();}
