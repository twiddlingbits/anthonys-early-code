...
ReadDir(disklist.gad_ptr,"Studio16:Apps/");
ReadDir(disklist.gad_ptr,"Studio16:Utilities/");
ReadDir(disklist.gad_ptr,"Studio16:Drivers/");
ReadDir(disklist.gad_ptr,"Studio16:ProjectMenu/");
...
if (! (fkey=(struct FileLock *)Lock(path,ACCESS_READ)) ) 
	{
	telluser("ModList:","Studio16: directory does not exist.",0);
	return;
	}
