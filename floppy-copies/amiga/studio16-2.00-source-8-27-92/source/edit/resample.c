...
{
int error;
long tau,tau_per_samp,frac_org_n;	/** Fixed point **/
int org_rate;
long new_length;
long new_n,org_n;
short *data;
...
while (new_length--) {
	...
	/** I keep inrementing "new_n" (the new sample's index) **/
	/** and generating the "old_n" + tau.  old_n + tau **/
