...
*
      ...
      move.b   #65,cra
      nop
;      move.b   #$0f,sdr          * KDAT low then high
;      move.w   #300,d2           * used to be 250
;pze:  nop                        * wait at least 75us
;      dbra     d2,pze

/** new stuff, untested **/

      move.b   #$03,sdr          * shift 00000011 @ 17 usec/bit (MSB 1st)
pze   btst     #3,icr            * wait for  KDAT to finish pulsing
      beq      pze               * by sending zeros & ones thru SP

/** end new stuff, untested **/

      move.b   #7,cra            * for toggle use 7, 11 for pulse
      nop
      move.b   icr,d2            * clear any SP interupt bits
