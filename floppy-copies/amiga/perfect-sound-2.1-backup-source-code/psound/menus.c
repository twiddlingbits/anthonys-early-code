...
struct MenuItem SubItems[] =
{
   ...
   {
      NULL, 191, 10, 64, 10, ITEMENABLED | ITEMTEXT | CHECKED|CHECKIT | HIGHCOMP,
   ...
   {
      &SubItems[12], 191, 0, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[11], NULL, NULL, NULL, NULL 
   },
   {
      &SubItems[13], 191, 10, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
struct MenuItem Items[] =
{
   ...
   {
      NULL, 0, 60, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
   ...
   },
   {
      ...
      0, (APTR)&ItemText[24], NULL, NULL, &SubItems[8], NULL 
   },
   {
      NULL, 0, 30, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[25], NULL, NULL, &SubItems[11], NULL 
   },
};

struct Menu Titles[] =
{
   { &Titles[1], 3, 0, 94, 0, MENUENABLED, " Project  ", &Items[0] },
   { &Titles[2], 96, 0, 62, 10, MENUENABLED, " Edit ", &Items[7] },
   { &Titles[3], 157, 0, 86, 10, MENUENABLED, " Special ", &Items[15] },
   { NULL, 242, 0, 94, 10, MENUENABLED, " Digitize ", &Items[22] },
};
