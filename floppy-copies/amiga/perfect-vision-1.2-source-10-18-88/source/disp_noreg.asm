...
*                                                  be set)
*
analyze     equ   0     1 iff analyze phase  (not needed with hamnoreg)
draw        equ   1     1 iff drawing phase
*
hamreg      equ   0     1 iff use ham mode with registers      (disp_line)
hamnoreg    equ   1     1 iff use ham mode without registers   (disp_noreg)
