...
* Now grab and hear the left channel

      move.w   #13,d1            * Give ADC chance to finish
eek:  dbra     d1,eek
      ...
      move.b   data1,d1          * 16  Get byte (0-255) from par:
      subi.l   #128,d1           * 8   Turn into 2's complement
      move.b   d1,(a2)           * 8   Save In buffer for later
      lsl      #8,d1             * Make a word with two identical
      move.b   (a2)+,d1          * bytes.
      move.w   d1,aud0dat        * writting to left channel
