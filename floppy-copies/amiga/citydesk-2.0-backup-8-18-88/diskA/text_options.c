...
static struct NewWindow NewWindowStructure1 = {
   ...
   328,106,
   0,2,
   GADGETDOWN+CLOSEWINDOW+GADGETUP,
...
printf("'%s'\n",fontsize);
      state->font_size = convert_string(fontsize);
printf("fontsize on exit is %d\n",state->font_size);
