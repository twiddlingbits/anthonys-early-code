...
char *_procname = "STUDIO_TOASTER12_HANDLER";	/* The name of the task to create         */
...
if (chan->flags & CK_CHAN_RECORD)
	{
	playkey=(struct ChanKey *)AllocChan(hand,0,CK_CHAN_PLAY);
	playkey2=(struct ChanKey *)AllocChan(hand,1,CK_CHAN_PLAY);
	if (playkey && playkey2) return(TRUE);
	else
		{
		if (playkey) {FreeChan(playkey);playkey=NULL;}
		if (playkey2) {FreeChan(playkey2);playkey2=NULL;}
		return(FALSE);
		}
	}
return(TRUE);
...
if (chan->flags & CK_CHAN_RECORD)
	...
	FreeChan(playkey2);playkey2=NULL;}
}
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
int AHTriggerList();
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
...
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
/**********************************/
struct NewAudioHandler me = {"ToasterJam12",0,0,AH_FILTER_ADJ|AH_GAIN_ADJ|AH_RATE_ADJ,4,1,1,1,12,0,0,
	...
	"Record",CHAN_RECORD|CK_TAP_INPUT,0,
	};
/**********************************/
...
if ((wind = OpenNewWind(&NewWind,mod->state,NULL,NULL))==NULL)  telluser("Toaster12 Handler:","Could not Open Window",0);
Ypos=0;
