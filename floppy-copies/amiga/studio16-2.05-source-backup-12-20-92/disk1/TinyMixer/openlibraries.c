...
if ((InterfaceBase=(struct Library *)OpenLibrary("Interface.library",0))==NULL)
	{telluser("Tiny Mixer:","Can not open interface lib",NULL);closelibraries();exit(10);}

if ((IntuitionBase=(struct IntuitionBase *)OpenLibrary("intuition.library",33))==NULL)
	{telluser("Tiny Mixer:","Use Workbench 1.2 or greater.",0);closelibraries();exit(10);}

if ((GfxBase=(struct GfxBase *)OpenLibrary("graphics.library",0))==NULL)
	{telluser("Tiny Mixer:","Can't open graphics library!",0);closelibraries();exit(10);}
