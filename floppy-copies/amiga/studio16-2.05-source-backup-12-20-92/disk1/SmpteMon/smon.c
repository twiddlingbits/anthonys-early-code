...
Dcolor=StudioBase->defaults.colors.gadget_window.topleft_3d;
...
if ((mod=(struct Module *)AddModule(&ModData))==0) 
	...
	telluser("SMPTE Mon:","Could Not Add Module",0);
	closelibraries();
	exit(10);
	}
...
if ((sink_sigbit=AllocSignal(-1))==-1) {telluser("SMPTE Mon:","Error 1, Can't get SigBit",NULL);}
sink_sigmask=1<<sink_sigbit;
if ((error_sigbit=AllocSignal(-1))==-1) {telluser("SMPTE Mon:","Error 2, Can't get SigBit",NULL);}
...
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
struct Window *HIDEwind=NULL;
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
void OpenHideWind()
{
struct Screen *screen=StudioBase->screen;
...
NewWind.Width = screen->Width;
NewWind.Height = screen->Height;

new_pointer(PTR_NOTHING);
HIDEwind = (struct Window *)OpenWindow(&NewWind);
WindowToBack(HIDEwind);
SetAPen(HIDEwind->RPort,0);
RectFill (HIDEwind->RPort,0,0,NewWind.Width-1,NewWind.Height-1);
}
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
void CloseHideWind()
...
if (HIDEwind) CloseWindow(HIDEwind);
HIDEwind=NULL;
}
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
/*­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­·­*/
...
while ((message=(struct IntuiMessage *)GetMsg(wind->UserPort))!=0)
	...
	if (class == MENUPICK)
		{
		if (Items[0].Flags&CHECKED) 
			{
			SetAPen(wind->RPort,0);
			SetBPen(wind->RPort,0);
			RectFill(wind->RPort,0,0,wind->Width-1,10);
			OpenHideWind();
			HIDE_MODE=TRUE;
			}
		if (Items[1].Flags&CHECKED && smptepaused==FALSE) PauseFunc(TRUE);
		if (!(Items[1].Flags&CHECKED) && smptepaused==TRUE) PauseFunc(FALSE);
		}
...
{
SmpteData(QuerySmpteTime());
if(flag) {Dcolor=StudioBase->defaults.colors.gadget_window.bottomright_3d;smptepaused=TRUE;}
else {Dcolor=StudioBase->defaults.colors.gadget_window.topleft_3d;smptepaused=FALSE;}
wdraw_digits();
}
