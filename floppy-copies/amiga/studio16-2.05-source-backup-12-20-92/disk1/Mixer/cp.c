...
/*** NOTE IF made resizeable MAKE SURE that no rendering takes place until window is resized!**/
/**********************************/
...
/*		new_gadget_size(PANgad[x].gad_ptr,0,0,0,wind->Height-10);*/
		}
