...
struct IntuiText ItemText[] =
{
	...
	{ 0, 1, JAM1, 0, 1, &taPlain, "   Fast Graph", NULL },
};
...
struct MenuItem Items[] =
{
	...
	},
	{
		...
		0, (APTR)&ItemText[4], NULL, 'L', NULL, NULL 
	},
	{
	...
	},
	{
		...
		0, (APTR)&ItemText[29], NULL, 'J', NULL, NULL 
	},
	{
	...
	{
		&Items[47], 0, 110, 195, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[46], NULL, NULL, &SubItems[6], NULL 
	},
	{
		NULL, 0, 120, 195, 10, MENUTOGGLE|ITEMENABLED | ITEMTEXT | HIGHCOMP|CHECKIT,
		0, (APTR)&ItemText[47], NULL, NULL, NULL, NULL 
	},
};
