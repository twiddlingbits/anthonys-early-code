...
struct IntuiText ItemText[] =
{
	...
	{ 0, 1, JAM1, 0, 1, &taPlain, "Text Attributes  ", NULL },
	{ 0, 1, JAM1, 0, 1, &taPlain, "Save", NULL },
...
struct MenuItem Items[] =
{
	...
	{
		&Items[16], 0, 0, 179, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[15], NULL, 'X', NULL, NULL 
	},
	{
		&Items[17], 0, 10, 179, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[16], NULL, 'C', NULL, NULL 
	},
	{
		&Items[18], 0, 20, 179, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[17], NULL, 'P', NULL, NULL 
	},
	{
		&Items[19], 0, 30, 179, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[18], NULL, NULL, NULL, NULL 
	},
	{
		&Items[20], 0, 40, 179, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[19], NULL, 'F', NULL, NULL 
	},
	{
		NULL, 0, 50, 179, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[20], NULL, 'A', NULL, NULL 
	},
	{
		&Items[22], 0, 0, 104, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[21], NULL, NULL, NULL, NULL 
	},
	{
		&Items[23], 0, 10, 104, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[22], NULL, NULL, NULL, NULL 
	},
	{
		&Items[24], 0, 20, 104, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[23], NULL, NULL, NULL, NULL 
	},
	{
		NULL, 0, 30, 104, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[24], NULL, NULL, NULL, NULL 
	},
	{
		&Items[26], 0, 0, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[25], NULL, NULL, NULL, NULL 
	},
	{
		&Items[27], 0, 10, 203, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[26], NULL, 'C', NULL, NULL 
	},
	{
		&Items[28], 0, 20, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[27], NULL, NULL, NULL, NULL 
	},
	{
		&Items[29], 0, 30, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[28], NULL, NULL, NULL, NULL 
	},
	{
		&Items[30], 0, 40, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[29], NULL, NULL, NULL, NULL 
	},
	{
		&Items[31], 0, 50, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[30], NULL, NULL, NULL, NULL 
	},
	{
		&Items[32], 0, 60, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
struct Menu Titles[] =
{
	...
	{ &Titles[3], 149, 0, 118, 10, MENUENABLED, "Preferences  ", &Items[21] },
	{ NULL, 266, 0, 86, 10, MENUENABLED, "General  ", &Items[25] },
};
