...
static struct NewButton but[] = {
	{&edit   ,11, 90,53,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Play"},
	{&save   ,60, 90,102,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Edit"},
	{&open   ,111,90,153,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Save"},
	{&close  ,160,90,202,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Open"},
	{&renamegd ,210,90,259,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Erase"},
	{NULL    ,210,90,259,100,BUTN_COOL|MANUAL_XOR,NULL,0,0,0,0,0,"Rename"}};

static struct NewList newopenlist = 
	{&play,10,16,260,86,LIST_COOL|LIST_SORTED|MANUAL_XOR,func_open_list,0,0,0,0,0,0};
...
show_gadget(open_list);
refresh_gadget(open_list);
...
if (ListChanged==TRUE)
	...
	hide_gadget(open_list);
	while(open_list->list_size)
		delete_list_entry_by_index(open_list,0);
