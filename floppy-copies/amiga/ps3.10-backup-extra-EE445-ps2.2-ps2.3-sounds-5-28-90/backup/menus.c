...
struct IntuiText ItemText[] =
{
	...
	{ 0, 1, JAM1, 0, 1, &taPlain, "Zoom Range", NULL },
...
struct MenuItem Items[] =
{
	...
	{
		&Items[28], 0, 30, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[27], NULL, NULL, &SubItems[9], NULL 
	},
	{
		NULL, 0, 40, 203, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[28], NULL, 'G', NULL, NULL 
	},
	{
		&Items[30], 0, 0, 219, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[29], NULL, 'T', NULL, NULL 
	},
	{
		&Items[31], 0, 10, 219, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[30], NULL, NULL, NULL, NULL 
	},
	{
		&Items[32], 0, 20, 219, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
struct Menu Titles[] =
{
	...
	{ NULL, 351, 0, 62, 10, MENUENABLED, " Other", &Items[29] },
};
