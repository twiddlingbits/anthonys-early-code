...
{
	{
		&SubItems[1], 191, 0, 40, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[0], NULL, NULL, NULL, NULL 
	},
	{
		NULL, 191, 10, 40, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[1], NULL, NULL, NULL, NULL 
	},
	{
		&SubItems[3], 191, 0, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[2], NULL, NULL, NULL, NULL 
	},
	{
		&SubItems[4], 191, 10, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
	...
	{
		&SubItems[6], 191, 0, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[5], NULL, NULL, NULL, NULL 
	},
	{
		&SubItems[7], 191, 10, 64, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
	...
	{
		&SubItems[10], 84, 10, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[9], NULL, NULL, NULL, NULL 
	},
	{
		NULL, 84, 20, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[10], NULL, NULL, NULL, NULL 
	},
	{
		&SubItems[12], 84, 0, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&SubText[11], NULL, NULL, NULL, NULL 
	},
	{
		&SubItems[13], 84, 10, 48, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
struct MenuItem Items[] =
{
	...
	},
	{
		...
		0, (APTR)&ItemText[11], NULL, 'X', NULL, NULL 
	},
	{
		&Items[13], 0, 40, 203, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[12], NULL, '/', NULL, NULL 
	},
	{
		NULL, 0, 50, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[13], NULL, NULL, &SubItems[0], NULL 
	},
	{
		&Items[15], 0, 0, 203, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[14], NULL, 'Z', NULL, NULL 
	},
	{
		&Items[16], 0, 10, 203, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[15], NULL, 'V', NULL, NULL 
	},
	{
		&Items[17], 0, 20, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[16], NULL, NULL, &SubItems[2], NULL 
	},
	{
		NULL, 0, 30, 203, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[17], NULL, NULL, &SubItems[5], NULL 
	},
	{
		&Items[19], 0, 0, 96, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[18], NULL, NULL, NULL, NULL 
	},
	{
		&Items[20], 0, 10, 96, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[19], NULL, NULL, &SubItems[8], NULL 
	},
	{
		NULL, 0, 20, 96, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
		0, (APTR)&ItemText[20], NULL, NULL, &SubItems[11], NULL 
	},
	{
		NULL, 0, 0, 155, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
		0, (APTR)&ItemText[21], NULL, 'P', NULL, NULL 
	},
};
...
struct Menu Titles[] =
{
	...
	{ &Titles[3], 149, 0, 94, 10, MENUENABLED, " Digitize ", &Items[14] },
	{ &Titles[4], 242, 0, 62, 10, MENUENABLED, " File ", &Items[18] },
	{ NULL, 303, 0, 94, 10, MENUENABLED, " About... ", &Items[21] },
};
