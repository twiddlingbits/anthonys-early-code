...
*** preferences.i ***********************************************************
*
*  the Preferences structure -- (extended by bart)
*
*  $Header:
*
...
*     ------       ------      -------------------------------------
*     3-1-85        -jimm       
*     8-11-85       -bart       split off from intuition.i      
*
****************************************************************************/
...
; Preferences Extension Size
PREF_EXTBYTES   EQU $00
...
; ------------------------------------------------------------------------
 STRUCTURE Preferences,0
    ...
    BYTE pf_sys_reserved1       ; 
    BYTE pf_sys_reserved2       ;
...
*    STRUCT  pf_ext_bytes,PREF_EXTBYTES   ; out until V1.3 -- bart
