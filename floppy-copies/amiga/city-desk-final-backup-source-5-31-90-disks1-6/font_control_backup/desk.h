...
#define BUSY 4
#define LINE 5
#define EDITOBJ 6      /* edit object options */
...
#define NO_TOOL_PICKED 27  /* used by picktool() when no tool was selected */
#define EXPLODE  28    /* User wants to draw a box outline */
#define GENOTHING   243    /** THOM added this for graphed **/
#define PASTE       29     /** paste in graphed **/
#define BOX_FLOW    30     /** create box and flow text into it **/
...
/** pointer mode (defined in the global variable "pointer_mode" **/

#define PTR_NORMAL 0       /** pointer does not find stamped objs **/
#define PTR_STAMPED 1      /** pointer does find stamped objs **/
#define PTR_LINKED 2       /** pointer ignores linked objects **/

/** returns from 'convert_gray_options' **/

#define GRAY_OUTOFMEM   1
#define GRAY_SAT        2
#define GRAY_OVERSAT    4
#define GRAY_NOWHITE    8
...
#define LINEWIDTH1  256    /** widths for outline obj **/
#define LINEWIDTH2  512
#define LINEWIDTH3  1024
#define LINEWIDTH4  2048
#define DASHEDLINE  4096   /** outline object is dashed **/
#define DO_NOT_DRAW 8192   /** don't redraw this object **/
#define JUST_LOADED 16384  /** used by 'fix_ptrs' when loading .cd **/
#define IRREGULAR   (1<<15)  /** this text object is irregularly flowed **/

struct object {
   struct Node node;
   UBYTE *screendata;        /* bitmap of object scaled to fit onto screen */
   struct object *top_link ; /* First in the link */
   struct object *next;      /* Next object in this link */
   struct object *first;     /* first object in this TEXT chain */
   APTR  data;               /* pts to additional structure for more info */
   ULONG flags;      /* outline, shadow, etc */
   COORD x, y;       /* Position of this object rel upper Left of page */
   COORD h, w;       /* Height and width of this object */
   USHORT pn;        /* page that contains this object */
   USHORT angle;     /* amount to rotate object before printing */
   USHORT dpi;       /* if laserprinter, print at this resolution */
   UBYTE numplanes;  /* one or two in version 2.0 */
   UBYTE type;       /* GRAPHIC, TEXT, etc. */
   UBYTE density;    /* percent 0 - 100 of black to render this obj in */
   UBYTE mag;        /* magnification of current screendata info */
   ULONG pad1;       /* reserved for latter use */
   };
