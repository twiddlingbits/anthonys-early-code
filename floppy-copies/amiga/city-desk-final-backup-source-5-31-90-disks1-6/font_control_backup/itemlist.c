...
static struct NewWindow rw = {
   ...
   WHITE,BLACK,   /* detail and block pens */
...
Gadget1.LeftEdge=len*8+118;  /* Bottom Right Corner */
...
/* SetRGB4(&screen->ViewPort, 1, 0, 0, 0); */    /** make gray black temp. **/
...
/*      SetRGB4(&screen->ViewPort, 1, 10, 10, 10); */       /** Gray **/
      return(TRUE);
      }
   }
goto loop;
