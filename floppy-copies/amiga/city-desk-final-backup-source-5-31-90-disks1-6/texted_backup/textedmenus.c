...
{
   { 0, 1, JAM1, 0, 1, &taPlain, "To Page", NULL },
   { 0, 1, JAM1, 0, 1, &taPlain, "To Cut", NULL },
   { 0, 1, JAM1, 0, 1, &taPlain, "From Page", NULL },
   { 0, 1, JAM1, 0, 1, &taPlain, "From Cut", NULL },
};
...
{
   {
      &SubItems[1], 159, 0, 99, 10, ITEMENABLED | ITEMTEXT | COMMSEQ | HIGHCOMP,
      0, (APTR)&SubText[0], NULL, 'O', NULL, NULL 
   },
   {
      NULL, 159, 10, 99, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[1], NULL, NULL, NULL, NULL 
   },
   {
      &SubItems[3], 159, 0, 88, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&SubText[2], NULL, NULL, NULL, NULL 
   },
   {
      NULL, 159, 10, 88, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
...
static struct MenuItem Items[] =
{
   ...
   {
      &Items[2], 0, 10, 171, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[1], NULL, NULL, &SubItems[0], NULL 
   },
   {
      &Items[3], 0, 20, 171, 10, ITEMENABLED | ITEMTEXT | HIGHCOMP,
      0, (APTR)&ItemText[2], NULL, NULL, &SubItems[2], NULL 
   },
   {
