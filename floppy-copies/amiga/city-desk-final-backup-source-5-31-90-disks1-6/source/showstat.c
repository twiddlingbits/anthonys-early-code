...
case CANTLINK:
      ...
      break;
case CANTBREAK:
      telluser2(screen,"Can't break text chain here.","",FALSE);
      break;
case CANTCONNECT:
      telluser2(screen,"I can only connect a final text",
                       "object to the start of a chain.",FALSE);
      break;
case VPLIBERR:
      telluser2(screen,"Error while opening",
                       "Virtual Page library.",FALSE);
      break;
   }
}
#endif
