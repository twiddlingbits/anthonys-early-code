...
if (width > 800) {
   ...
   cust.Font=&thefont;
   #if GERMAN
   cust.DefaultTitle="City Desk 2.01 © 1987 & 1989 MicroSearch.  Entwickelt von  SunRize Industries";
   #else
   cust.DefaultTitle="City Desk 2.01 © 1987 & 1989 MicroSearch.  Written By SunRize Industries";
   #endif
   cust.Gadgets=0;
   cust.CustomBitMap=0;
