...
while (TRUE) {
   ...
   while ((message=GetMsg(w->UserPort))!=NULL) {
      ...
      if (class==CLOSEWINDOW) {
         ...
         else if (two.Flags & SELECTED) newmag = 2;
         else if (three.Flags & SELECTED) newmag = 3;
         else if (four.Flags & SELECTED) newmag = 4;
         else if (five.Flags & SELECTED) newmag = 5;
         else if (six.Flags & SELECTED)  newmag = 6;
         else newmag = oldmag;
