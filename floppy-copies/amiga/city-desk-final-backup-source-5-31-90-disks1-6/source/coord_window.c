...
ModifyIDCMP(coord_window,CLOSEWINDOW|MENUPICK|MOUSEBUTTONS|RAWKEY);
...
{
if (coord_window) {
   coord_window->UserPort=NULL;   /* U.P. is clipboard's */
   ModifyIDCMP(coord_window,NULL);
