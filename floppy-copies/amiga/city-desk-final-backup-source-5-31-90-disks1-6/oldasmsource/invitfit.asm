...
*-----------------------------------------------------------------------
* invitfit.asm       (5-11-87 aw)
*-----------------------------------------------------------------------
* Calling sequence:
*   invitfit (srcdata,  srcoff,  srcmodulo, destoff);
*
*-----------------------------------------------------------------------
*
* Function:
*
*   Resizes the source bitmap to fit in the destination bitmap, with
*   italicshift subtracted from each line to do italics.
...
*        the problem with chopping off descenders.  Ditto for _fitp_xfudge.
*
*-----------------------------------------------------------------------
*
* Register Usage:
...
*   d3.w = dest offset in leftover bits             (var)
...
*
      ...
      XREF  _fitp_italicshift ; italic shift per dest line     l
...
_invitfit:
      ...
      clr.w    destline(a6)               * initialize vertical loop
